...
#----------------------
cp -r echo-nginx-module-0.62/git/echo-nginx-module-0.62
cp -r nginx-module-vts-0.2.1 /git/nginx-module-vts-0.2.1
cp -r nginx-rtmp-module-master /git/nginx-rtmp-module-master
